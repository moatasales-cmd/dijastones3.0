...
const s = StyleSheet.create({
  ...
  header: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16, paddingBottom: 10, borderBottomWidth: 2, borderBottomColor: "#915D36" },
  logo: { height: 32, width: 100, objectFit: "contain" },
  docTitle: { fontSize: 15, fontFamily: "Helvetica-Bold" },
  meta: { fontSize: 8, color: "#6b6560" },
  sectionTitle: { fontSize: 11, fontFamily: "Helvetica-Bold", color: "#915D36", marginTop: 12, marginBottom: 6, paddingBottom: 3, borderBottomWidth: 1, borderBottomColor: "#e0d8d0" },
  infoGrid: { flexDirection: "row", gap: 16, marginBottom: 8 },
  infoBlock: { flex: 1 },
  label: { fontSize: 7, letterSpacing: 1, textTransform: "uppercase", color: "#915D36", fontFamily: "Helvetica-Bold", marginBottom: 2 },
  p: { fontSize: 9, lineHeight: 1.5 },
  small: { fontSize: 7.5, color: "#6b6560" },
  table: { width: "100%", marginBottom: 10 },
  tr: { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: "#e0d8d0", alignItems: "center", paddingVertical: 4 },
  th: { fontSize: 6.5, letterSpacing: 0.5, textTransform: "uppercase", color: "#915D36", fontFamily: "Helvetica-Bold" },
  photoCol: { width: 30 },
  stoneCol: { flex: 2 },
  colSm: { flex: 0.9, textAlign: "center" },
  colNum: { flex: 1, textAlign: "right" },
  photo: { width: 26, height: 26, objectFit: "cover", borderRadius: 2 },
  totalsWrap: { alignSelf: "flex-end", width: 260, marginTop: 4 },
  totalsRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 2 },
  totalsGrand: { flexDirection: "row", justifyContent: "space-between", paddingTop: 4, marginTop: 4, borderTopWidth: 2, borderTopColor: "#1a1a1a", fontFamily: "Helvetica-Bold", fontSize: 11 },
  box: { backgroundColor: "#f8f6f3", borderLeftWidth: 3, borderLeftColor: "#915D36", padding: 10, marginBottom: 8 },
  footer: { flexDirection: "row", justifyContent: "space-between", marginTop: 16, paddingTop: 8, borderTopWidth: 1, borderTopColor: "#e0d8d0", fontSize: 7.5, color: "#6b6560" },
  tncLine: { fontSize: 7, color: "#6b6560", marginBottom: 2, lineHeight: 1.4 },
});
